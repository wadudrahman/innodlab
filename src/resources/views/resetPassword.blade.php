        ...
        <div class="card">
                ...
                <form role="form" method="post" action="{{ url('login') }}">
                    ...
                    <div class="form-group">
                        <label class="form-label d-flex justify-content-between align-items-end">
                            <div>Password</div>
                            <a href="{{ url('password/reset') }}" class="d-block small">Forgot password?</a>
                        </label>
                        <input type="password" class="form-control" id="password" name="password">
                    </div>
                    <div class="text-center">
                        <button class="btn btn-primary" type="submit" id="login_btn"
                                name="login_btn"><strong>Log In</strong></button>
                    </div>
                </form>
                <!-- / Form -->
            ...
            <div class="card-footer py-3 px-4 px-sm-5">
                <div class="text-center text-muted">
                    Don't have an account yet? <a href="{{ url('registration') }}">Sign Up</a>
                </div>
            </div>
        </div>

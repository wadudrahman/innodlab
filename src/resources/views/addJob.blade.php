                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="clientId" name="clientId">
                                                <option value="">Client Name 1 (Client ID)</option>
                                                <option value="">Client Name 2 (Client ID)</option>
                                                <option value="">Client Name 3 (Client ID)</option>
                                                <option value="">Client Name 4 (Client ID)</option>
                                            </select>
                                        </div>
                                    </div>

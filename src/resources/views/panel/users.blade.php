                        ...
                        <div class="table-responsive ui-bordered">
                            <table class="clients-table table table-hover m-0">
                                ...
                                <tr>
                                    <td class="align-middle py-3">
                                        <div class="media align-items-center">
                                            <img src="{{ url('pane/img/avatars/6-small.png') }}" class="d-block ui-w-40 rounded-circle" alt="">
                                            <div class="media-body flex-basis-auto pl-3">
                                                <div>Mae Gibson</div>
                                ...
                                <tr>
                                    <td class="align-middle py-3">
                                        <div class="media align-items-center">
                                            <img src="{{ url('/img/avatars/3-small.png') }}" class="d-block ui-w-40 rounded-circle" alt="">
                                            <div class="media-body flex-basis-auto pl-3">
                    ...
                    <div class="clients-sidebox bg-body border-left">
                        ...
                        <div class="clients-scroll container-p-y">
                            ...
                            <div class="text-center p-4">
                                <img src="{{ url('panel/img/avatars/9.png') }}" class="ui-w-100 rounded-circle mb-4" alt="">

            ...
            <div class="col-sm-6 col-xl-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-footer">
                        <button type="button" class="btn btn-xs btn-outline-primary icon-btn float-right"><i
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="custom-controls-stacked">
                                        <label class="ui-todo-item custom-control custom-checkbox">
                                            ...
                                            <span
                                                class="ui-todo-badge badge badge-outline-default font-weight-normal ml-2">58 mins left</span>
                                        </label>
                                        <label class="ui-todo-item custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input">
                                        ...
                                        <label class="ui-todo-item custom-control custom-checkbox">
                                            ...
                                            <span
                                                class="ui-todo-badge badge badge-outline-default font-weight-normal ml-2">20 hours left</span>
                                        </label>
                                        <label class="ui-todo-item custom-control custom-checkbox">
                                ...
                                <div class="card-body">
                                    <div class="rounded ui-bordered p-3 mb-3">
                                        ...
                                        <div class="media align-items-center mt-3">
                                            <img src="{{ asset('panel/img/avatars/12-small.png') }}"
                                    ...
                                    <div class="rounded ui-bordered p-3 mb-3">
                                        ...
                                        <div class="media align-items-center mt-3">
                                            <img src="{{ asset('panel/img/avatars/11-small.png') }}"
                                                 class="d-block ui-w-30 rounded-circle" alt>
                                    ...
                                    <div class="rounded ui-bordered p-3">
                                        ...
                                        <div class="media align-items-center mt-3">
                                            <img src="{{ asset('panel/img/avatars/10-small.png') }}"
                                                 class="d-block ui-w-30 rounded-circle" alt>
                                            <div class="media-body ml-2">Abir Ahsan</div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="media pb-1 mb-3">
                            <img src="{{ asset('panel/img/avatars/9-small.png') }}"
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p class="my-1">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque
                        ...
                        <div class="media pb-1 mb-3">
                            <img src="{{ asset('panel/img/avatars/8-small.png') }}"
                                 class="d-block ui-w-40 rounded-circle" alt>
                            <div class="media-body ml-3">
                                <a href="javascript:void(0)">Hallie Lewis</a>
                                <span class="text-muted">commented on</span>
                                <a href="javascript:void(0)">Article Name</a>
                                <p class="my-1">Vivendum torquatos ut nec, sit audiam deterruisset ei, cu sed nibh autem
                                    scriptorem. Ea quo vidit deleniti constituto, ex qui malis mollis iudicabit, viris
                                    fabellas id has.</p>
                                <div class="clearfix">
                                    <a href="javascript:void(0)" class="float-right text-lightest small">
                                        <span class="ion ion-ios-thumbs-down"></span>
                        ...
                        <div class="media">
                            <img src="{{ asset('panel/img/avatars/7-small.png') }}"
                                 class="d-block ui-w-40 rounded-circle" alt>
                            <div class="media-body ml-3">
                    ...
                    <a href="javascript:void(0)"
                       class="card-footer d-block text-center text-body small font-weight-semibold">SHOW MORE</a>
                </div>
                <!-- / Comments -->
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="pb-1 mb-3">
                            ...
                            <br>
                            <small class="text-muted">Created by <a href="javascript:void(0)" class="text-body">Mike
                                    Greene</a> &nbsp;·&nbsp; 1 day ago</small>
                        </div>
                        <div class="pb-1 mb-3">
                            ...
                            <br>
                            <small class="text-muted">Created by <a href="javascript:void(0)" class="text-body">Leon
                                    Wilson</a> &nbsp;·&nbsp; 1 day ago</small>
                        </div>
                        <div class="pb-1 mb-3">
                            ...
                            <span class="text-muted">#34563</span>
                            <br>
                            <small class="text-muted">Created by <a href="javascript:void(0)" class="text-body">Allie
                                    Rodriguez</a> &nbsp;·&nbsp; 1 day ago</small>
                        </div>
                        <div class="pb-1 mb-3">
                            ...
                            <span class="text-muted">#34563</span>
                            <br>
                            <small class="text-muted">Created by <a href="javascript:void(0)" class="text-body"> Kenneth
                                    Frazier</a> &nbsp;·&nbsp; 1 day ago</small>
                        </div>
                        <div>
                            <div class="badge badge-outline-danger float-right">Bug</div>
                            <a href="javascript:void(0)">Dicunt prodesset te vix.</a>&nbsp;
